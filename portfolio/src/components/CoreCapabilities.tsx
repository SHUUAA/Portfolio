...
const CAPABILITIES = [
  { title: 'Agentics & AI Integration', desc: 'Building agentic automation pipelines with n8n, OpenClaw, and Claude AI — from prompt engineering and LLM integration to fully autonomous task workflows. Leverages RAG, vector embeddings, and pgvector for intelligent retrieval.', tags: ['n8n', 'OpenClaw', 'Claude AI', 'LLM', 'RAG', 'Vector Embeddings', 'pgvector'] },
  ...
  { title: 'Marketing & Tracking', desc: 'End-to-end campaign management and analytics — running Meta Ads, implementing UTM parameters, integrating GA4 tagging, and tracking campaign performance through HubSpot and GoHighLevel dashboards.', tags: ['Meta Ads', 'GA4', 'UTM Parameters', 'HubSpot', 'GoHighLevel'] },
      ...
      <div className="grid grid-cols-12 border-b-2 border-border">
        ...
        <div className="col-span-12 md:col-span-8 px-6 md:px-10 py-8 md:py-12 flex items-end">
          <p className="text-base md:text-lg font-medium text-fg-muted max-w-2xl leading-snug">
            Six overlapping disciplines. Each row defines a domain of practice — selected
