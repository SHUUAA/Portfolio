...
const DEFAULT_IMAGES: ImageItem[] = [
  ...
  {
    src: 'https://images.unsplash.com/photo-175353985163-c2a0fe5ac3d8?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
...
const DomeGallery = forwardRef<DomeGalleryHandle, DomeGalleryProps>(function DomeGallery({
  ...
  // Methods for external control (hand tracking)
  const setBaseRotation = useCallback(() => {
    stopInertia();
  ...
  const updateRotation = useCallback((dx: number, dy: number) => {
    ...
    if (rotationRef.current.x !== nextX || rotationRef.current.y !== nextY) {
      ...
      if (onRotationChange) onRotationChange(nextY);
    }
  }, [onRotationChange]);
